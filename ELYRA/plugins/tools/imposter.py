...
from ELYRA.mongo.pretenderdb import (
    impo_off, impo_on, check_pretender,
    add_userdata, get_userdata, usr_data
)
from ELYRA.utils.admin_filters import admin_filter
...
""".format(
    ...
    if msg != "":
        await message.reply_photo("https://file.garden/aeT9p6iUoRzyQ9xJ/help.jpg", caption=msg)
