...
from ELYRA.core.dir import COUPLE_DIR
from ELYRA.mongo.couples_db import get_couple, save_couple


ASSETS = Path("ELYRA/assets")
...
async def generate_image(chat_id: int, uid1: int, uid2: int, date: str) -> str:
    base = Image.open(ASSETS / "elyra/couple.png").convert("RGBA")
