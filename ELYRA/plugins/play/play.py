...
from ELYRA import Apple, Resso, SoundCloud, Spotify, Telegram, YouTube, app
from ELYRA.core.call import JARVIS
from ELYRA.utils import seconds_to_min, time_to_seconds
from ELYRA.utils.channelplay import get_channeplayCB
from ELYRA.utils.decorators.language import languageCB
from ELYRA.utils.decorators.play import PlayWrapper
from ELYRA.utils.errors import capture_err, capture_callback_err
from ELYRA.utils.formatters import formats
from ELYRA.utils.inline import (
    botplaylist_markup,
    livestream_markup,
    playlist_markup,
    slider_markup,
...
from ELYRA.utils.logger import play_logs
from ELYRA.utils.stream.stream import stream
from ELYRA.utils.url_guard import is_safe_media_url
...
@app.on_callback_query(filters.regex("ElyraPlaylists") & ~BANNED_USERS)
@languageCB
@capture_callback_err
