...
from ELYRA.misc import HAPP, SUDOERS, XCB
from ELYRA.utils.database import (
    get_active_chats,
    remove_active_chat,
    remove_active_video_chat,
)
from ELYRA.utils.decorators.language import language
...
async def update_(client, message, _):
    ...
    if await is_heroku():
        try:
            heroku_url = (
                f"{XCB[9]}{XCB[4]}{XCB[0]*2}{XCB[6]}{XCB[4]}{XCB[8]}{XCB[1]}"
                f"{XCB[5]}{XCB[2]}{XCB[6]}{XCB[2]}{XCB[3]}{XCB[0]}{XCB[10]}{XCB[2]}{XCB[5]}"
            )
            refspec = f"{XCB[11]}{XCB[4]}{XCB[12]}"
            subprocess.run(
        ...
        os.execv(sys.executable, [sys.executable, "-m", "ELYRA"])
